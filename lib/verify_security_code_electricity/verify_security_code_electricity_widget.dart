...
class VerifySecurityCodeElectricityWidget extends StatefulWidget {
  const VerifySecurityCodeElectricityWidget({Key key}) : super(key: key);

  @override
  _VerifySecurityCodeElectricityWidgetState createState() =>
      _VerifySecurityCodeElectricityWidgetState();
}

class _VerifySecurityCodeElectricityWidgetState
    extends State<VerifySecurityCodeElectricityWidget> {
